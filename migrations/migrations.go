...
var Names = []string{"001_initial.sql", "002_github_setup.sql", "003_repository_contract.sql", "004_pr_readiness.sql", "005_cli_identity.sql", "006_repo_crypto.sql", "007_secret_versions.sql"}
